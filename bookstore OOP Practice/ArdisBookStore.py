#Artis version of the book store app
#2/7/17
#

from tkinter import *

from BSBackend import Database
...
window=Tk()
window.wm_title("Ardis Book Store")
...
b6=Button(window, text="Commit", width=12, command=commit_command)
